...
public class TripsSmartTabsTripsActivity extends AnimationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_trips_smart_trips);
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFrag(new SevenDaysTripFragment(),"Trip");
        adapter.addFrag(new CreateTripFragmentNew(),"Smart Trip");
